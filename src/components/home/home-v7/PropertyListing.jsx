      ...
      <div className="row">
        <div className="col-lg-9">
          <div className="main-title2">
            <h2 className="title">
              Explore Trending Properties: Uncover Your Ideal Investment
            </h2>
            <p className="paragraph">
              Embark on a journey to discover popular properties in UAE&apos;s
              thriving real estate market. Browse our curated collection
              featuring a diverse range of investment opportunities. Find your
              perfect property match today!
            </p>
          </div>
        </div>
        {/* End .col-lg-9 */}
