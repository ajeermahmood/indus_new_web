      ...
      <div className="container">
        <div className="row" data-aos="fade-up" data-aos-delay="100">
          <div className="col-lg-12">
            <h2 className="blog-title">{blogData.blogs_title}</h2>
            <div className="blog-single-meta">
              <div className="post-author d-sm-flex align-items-center">
                ...
                <a className="ml0" href="#">
                  ...
                  {new Date(blogData.blogs_date).toDateString().split(" ")[0]}{" "}
                  {new Date(blogData.blogs_date).toDateString().split(" ")[1]}{" "}
                  {new Date(blogData.blogs_date).toDateString().split(" ")[2]},{" "}
                  {new Date(blogData.blogs_date).toDateString().split(" ")[3]}
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            ...
            >
              <Image
                ...
                src={`https://www.indusre.com/blogsimg/${blogData.blogs_mainimage}`}
                alt="blog"
              />
            </div>
          </div>
