...
export const metadata = {
  title: "Privacy Policy | Indus Real Estate LLC",
};
...
const PrivacyPolicyPage = () => {
  return (
    <>
      ...
      {/* Breadcumb Sections */}
      <section className="breadcumb-section pt130 pb10">
        ...
        <div className="container">
          <div class="mt-3 mt-md-4">
            ...
            <p>
              ...
              for Indus Real Estate LLC is created with the help of the
            ...
            <p>
              Indus Real estate LLC uses the collected data for various
              purposes:
            </p>
            <ul>
            ...
            <p>
              If you are located outside United Arab Emirates and choose to
              provide information to us, please note that we transfer the data,
              including Personal Data, to United Arab Emirates and process it
              there.
            </p>
            <p>
            ...
            <p>
              Indus Real estate LLC will take all steps reasonably necessary to
            ...
            <p>
              Indus Real estate LLC may disclose your Personal Data in the good
              faith belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Indus Real
                estate LLC
              </li>
              <li>
            ...
            <ul>
              <li>By email: info@indusre.com</li>
              <li>By calling us: +971 4351 9995 / 800 INDUS(46387)</li>
            </ul> */}
          </div>
        </div>
      </section>
